package gomez.abraham.thecheezery
...
class SweetsActivity : AppCompatActivity() {
    ...
    fun agregaProductos(){
        ...
        sweets.add(Product("Cherry cheesecake", R.drawable. strawberrycheesecake,"his cherry topped cheesecake is positively creamy and delicious and will be your new favorite dessert.", 7))
